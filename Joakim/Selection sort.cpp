...
// 
// Auxiliary space: O(1) as the only extra memory udes is for temporary variables while
// swapping two values in Array. The selection sort never makes more than O(N) swaps 
